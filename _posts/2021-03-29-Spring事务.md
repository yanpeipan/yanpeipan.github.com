...
![Spring 事务抽象]({{ 'assets/image/Spring 事务抽象.png' | relative_url }})
...
![]({{ 'assets/image/spring/AbstractAutoProxyCreator.jpeg' | relative_url }})
...
![Spring 事务抽象]({{ 'assets/image/spring/TransactionSynchronizationManager.jpeg' | relative_url }})
